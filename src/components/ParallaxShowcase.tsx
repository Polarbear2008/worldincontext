    ...
    <section ref={ref} className="relative py-24 md:py-32 overflow-hidden">
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-5xl mx-auto text-center mb-14">
          ...
          >
            A parallax showcase that reveals depth as you scroll.
          </motion.p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          {[
            {
              title: "Business",
              desc: "Insights from global markets.",
            },
            {
              title: "Politics",
              desc: "Context behind world affairs.",
            },
            {
              title: "Geography",
              desc: "Places and people in motion.",
            },
          ].map((card, i) => (
            <motion.div
              key={i}
